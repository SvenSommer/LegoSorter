# 1 "C:\\Users\\RHOFFM~1\\AppData\\Local\\Temp\\tmpehsbglov"
#include <Arduino.h>
# 1 "Y:/motorcontroller/PlatformIO/ScaleControllerLCD/src/ScaleControllerLCD.ino"
#include "Arduino.h"
...
#line 68 "Y:/motorcontroller/PlatformIO/ScaleControllerLCD/src/ScaleControllerLCD.ino"
void setup() {
  SetupOTA(NameforClient, mySSID, myPASSWORD);

  myLocalTime.setLocation(F("de"));
